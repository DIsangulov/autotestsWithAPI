...
class XbaCook(BaseReq):
    ...
    def xba_cook_dashboard_post(self, token):
        data = {
    ...
    def xba_cook_entity_post(self, token):
        data = {
            "end": "",
            "name": "user",
            "start": "",
    ...
    def xba_cook_entity_details_post(self, token):
        data = {
            "end": "",
            "name": "user",
            "start": "",
    ...
    def xba_cook_entity_info_post(self, token):
        data = {
            "name": "user",
            "type": ""
        }
    ...
    def xba_cook_entity_info_settings_get(self, token):
        header = {'token': token}
    ...
    def xba_cook_entity_info_settings_entity_type_delete(self, token):
        header = {'token': token}
        resp = self.sess.delete(f"{self.host}/back/dp.xba_cook/entity/info/settings/name", headers=header, verify=False)
        return resp

    def xba_cook_entity_picker_min_max_post(self, token):
        data = {
            "name": "user",
            "type": "user"
        }
    ...
    def xba_cook_entity_risks_description_post(self, token):
    ...
    def xba_cook_profiles_get(self, token):
        header = {'token': token}
    ...
    def xba_cook_profiles_categories_get(self, token):
        header = {'token': token}
        resp = self.sess.get(f"{self.host}/back/dp.xba_cook/profiles/categories", headers=header, verify=False)
        return resp

    def xba_cook_profiles_export_profiles_post(self, token):
    ...
    def xba_cook_profiles_functions_get(self, token):
        header = {'token': token}
        resp = self.sess.get(f"{self.host}/back/dp.xba_cook/profiles/functions", headers=header, verify=False)
        return resp

    def xba_cook_profiles_graph_drilldown_statement_id_post(self, token):
        data = {
            "columns": [
                ""
            ],
    ...
    def xba_cook_profiles_graph_drilldown_id_post(self, token):
        data = {
            "columns": [
                ""
            ],
    ...
    def xba_cook_profiles_max_min_id_get(self, token):
        header = {'token': token}
        resp = self.sess.get(f"{self.host}/back/dp.xba_cook/profiles/graph/max_min/" + str(prof_id), headers=header,
                             verify=False)
        return resp

    def xba_cook_profiles_graph_personal_id_post(self, token):
        data = {
            "end": "2023-02-14T00:00:00Z",
            "name": "",
            "start": "2023-02-13T00:00:00Z",
    ...
    def xba_cook_profiles_graph_id_post(self, token):
        data = {
            "end": "2023-02-14T00:00:00Z",
            "name": "",
            "start": "2023-02-13T00:00:00Z",
    ...
    def xba_cook_profiles_groups_post(self, token):
        global rand
    ...
    def xba_cook_profiles_groups_get(self, token):
        header = {'token': token}
    ...
    def xba_cook_profiles_groups_put(self, token):
        data = {
            "id": group_id,
    ...
    def xba_cook_profiles_groups_id_max_min_get(self, token):
        header = {'token': token}
        resp = self.sess.get(f"{self.host}/back/dp.xba_cook/profiles/groups/2/max_min", headers=header, verify=False)
        return resp

    def xba_cook_profiles_groups_profile_id_group_id_weight_get(self, token):
        header = {'token': token}
        resp = self.sess.get(
    ...
    def xba_cook_profiles_id_whitelist_element_post(self, token):
        data = {"data": "ApiTest"}
        header = {'token': token}
    ...
    def xba_cook_profiles_id_string_whitelist_get(self, token):
        header = {'token': token}
    ...
    def xba_cook_profiles_id_list_whitelist_get(self, token):
        header = {'token': token}
