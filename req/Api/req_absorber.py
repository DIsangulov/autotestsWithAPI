...
class Absorber(BaseReq):
    ...
    def absorber_library_conn_type_id_get(self):
        ...
        _id = 1     # FIXME: magic
        header = {'token': self.token}
        resp = self.sess.get(f"{self.host}/back/dp.absorber/library/conn_type/{_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_library_connector_id_get(self):
        ...
        header = {'token': self.token}
        resp = self.sess.get(f"{self.host}/back/dp.absorber/library/connector/{con_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_library_connector_delete(self):
        ...
        con_id = self._get_connector_id()
        header = {'token': self.token}
        resp = self.sess.delete(f"{self.host}/back/dp.absorber/library/connector/{con_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_library_logo_delete(self):
        ...
        _logo_id = self._get_logo_id()
        header = {'token': self.token}
        resp = self.sess.delete(f"{self.host}/back/dp.absorber/library/logo/{_logo_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_source_id_get(self):
        ...
        _source_id = self._get_source_id()
        header = {'token': self.token}
        resp = self.sess.get(f"{self.host}/back/dp.absorber/source/{_source_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_source_id_delete(self):
        ...
        _source_id = self._get_source_id()
        header = {'token': self.token}
        resp = self.sess.delete(f"{self.host}/back/dp.absorber/source/{_source_id}", headers=header, verify=False)
        return resp
    ...
    def absorber_source_id_debug_get(self):
        ...
        _source_id = self._get_source_id()
        header = {'token': self.token}
        resp = self.sess.get(f"{self.host}/back/dp.absorber/source/{_source_id}/debug", headers=header, verify=False)
        return resp
